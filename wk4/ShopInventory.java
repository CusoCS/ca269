 ...
 */
 ...
 public class ShopInventory {
     ...
     public static void main(String[] args) {
         ...
         // Total Amount: 48.75
        //  abstract class Item {
        //     private static int inventoryCount = 0; // count of ALL items
        //     public static int getItemsDelivered() {
        //         return Item.inventoryCount;
        //     }
        //     Item() {
        //         Item.inventoryCount += 1; // this will get called from subclass
        //     }
        // }
        
        // class Milk extends Item {
        //     private Milk() {
        //         super(); // the delivered count is incremented
        //     };
        //     private static int inventoryCount = 100;
        //     public static int getInventoryCount() {
        //         return Milk.inventoryCount;
        //     }
        //     public static Milk getMilk() {
        //         Milk.inventoryCount -= 1; // the inventory count is decreased
        //         System.out.println("Retrieved Milk");
        //         return new Milk();
        //     }
        // }
        
        // class Shop {
        //     public Item getItem(Class item) { // class as a parameter type!
        //         if (item == Milk.class) { // Milk.class is the 'class Milk'
        //             return Milk.getMilk(); // think: would item.getMilk() work?
        //                                    //        why not? how to get it working?
        //         }
        //         return null;
        //     }
        //     public Item[] getItems(Class item, int count) { // for convenience
        //         Item[] items = new Item[count];
        //         for(int i=0; i<count; i++) {
        //             if (item == Milk.class) {
        //                 items[i] = Milk.getMilk();
        //             }
        //         }
        //         return items;
        //     }
        ...
        //         System.out.println("Items Delivered:" + Item.getItemsDelivered());
        //         System.out.println("Milk in Inventory:" + Milk.getInventoryCount());
        //         System.out.println("-------------------------------");
        //         myshop.getItems(Milk.class, 2);
        //         System.out.println("-------------------------------");
        //         System.out.println("Milk in Inventory:" + Milk.getInventoryCount());
        //         System.out.println("Items Delivered:" + Item.getItemsDelivered());
        //     }
        ...
        // public class GenericFactory<T> { // <--- note <T> syntax; <> means parameter
        //     private T singleton; // <--- hereafter T is used as a Type
        //     public T getNewItem() { // e.g. return type is T
        //         return singleton;
        //     }
        //     GenericFactory(T singleton) { // e.g. argument type is T
